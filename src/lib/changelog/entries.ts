...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  ...
  // ── Training Week: October's planning grid
  {
    ...
    body: "**Choose and Rank Your Sessions** on the live registration now matches the coordinators’ October grid — and so do the Admin calendar, the Workshop rows and the flow chart:\n\n- **Mon 26 Oct** — one **Company tour + Lunch & Learn**, 09:30–15:30, 20 places, host to be confirmed. The **Catalent** tour is gone; **CCRM** has moved to Tuesday.\n- **Mon 26 Oct** — the CL3 workshop is now **Pandemic Preparedness — THCF**, 09:30–14:00, 20 places.\n- **Tue 27 Oct** — **Negotiation Skills** is now **Negotiation Navigator**, and both afternoon workshops **end at 16:00** — Communication Chameleon moves back from the 16:30 it was corrected to. The CCRM tour joins the day as **Discovery to Delivery — CCRM**, 15:00–17:00, 18 places at MaRS.\n- **Wed 28 Oct** — the innovation showcase is **Innovation Ignited**, 10:00–13:30.\n\nEvery session now says **how many places it holds**, and the clash warnings follow the new times: Monday’s two options overlap, and the CCRM tour runs into the end of both Tuesday workshops. The paragraph asking people to choose between the Monday tours has gone with them.\n\n**Version 1 is untouched**, as always — the people who registered on it see exactly what they saw, and their picks still reach the right session.",
    kind: "improvement",
    visibleTo: STAFF,
    daysAgo: 0,
  },
  ...
  // ── Training admin: decide first, email when you choose
  {
    ...
    body: "Approving, waitlisting, declining or taking a seat back now **only records the decision**. The letter waits until you send it.\n\n- **Letters box** (on Registrants and Seat suggestions): shows how many decisions have not been emailed yet. Pick **one workshop or all of them** and press **Send** \u2014 it confirms the count first.\n- **One at a time:** each seat in a registration shows *Letter not sent* with a **Send letter** button, or when it was emailed.\n- **Change your mind freely before sending.** Each seat remembers what the person was last told, so approving and then waitlisting before any letter goes out sends **one** waitlist letter \u2014 not two. Taking a seat back to *Not decided* still sends nothing.\n- A letter that fails to send stays in the queue, so it is never silently lost.\n- **Seat suggestions \u2192 Apply** records the suggested decisions without emailing; send them from the Letters box when ready.\n- **Registrants** has a *Letter* column (Not sent / Sent), and **deleting a registration now asks for confirmation**, naming the person and how many seat requests go with it.",
    kind: "improvement",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  ...
  // ── Video Production: the promo-shoot budget
  {
    ...
    body: "**Workspace \u2192 Video Production** now has two tabs: **Projects** (unchanged) and **Production cost** \u2014 the budget for the BHN Promo Video shoot on Tuesday 6 October.\n\n- **Camera** \u2014 2D House quote 263434, without the Atlas Mercury 72 mm lens: $2,277.84 with HST.\n- **Lens** \u2014 Caldwell Chameleon 75 mm anamorphic from William White, $577.15 all-in.\n- **Sound & lighting** \u2014 CamArt Productions quote 1237: $1,243.00.\n- **Parking** \u2014 your car and the lighting / sound technician\u2019s truck for the day at the Landmark Garage under King\u2019s College Circle, $22 each.\n- **Insurance** \u2014 struck out: no insurance premium is charged for U of T equipment rental agreements (Office of Enterprise Risk Management & Insurance).\n- **Catering** \u2014 lunch for 10 (Molly, Gilbert, Darius, Yoo Jin, Ruilin, Roshni, Yeseul, Epshita, Alison and the lighting / sound technician) at U of T\u2019s 2026 lunch allowance of $25 a person, plus 2 Tim Hortons coffee boxes.\n\nEach section says whether it is **Quoted** or an **Estimate**, with the working behind it. The total, taxes in, is **$4,446.21**.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  // ── Workspace: sub-tabs in script guides + the Year in Review video tab
  {
    ...
    body: "Tabs in a script guide can now hold tabs of their own. In the **BHN Scientific Directors Video** guide:\n\n- **Pillar leads** splits into **ENGAGE**, **EXPERIENCE** and **EQUIP**, each with its own heading and its 2.5-minute script.\n- A new top-level **Year in Review** tab holds the film for the Symposium on 29 October: the brief, three concepts, a recommendation, a 3-minute beat sheet, then a section per pillar (**ENGAGE / EXPERIENCE / EQUIP in the film** \u2014 three directions, shots needed, what goes on screen, what to gather), the numbers board, an asset checklist and a schedule counting back from the 29th. Each pillar section also cuts down to a 45\u201360 second stand-alone reel.\n\nEvery figure in those drafts is marked **[confirm]** until a pillar lead signs it off. The rail on the left shows sub-tabs indented under whichever tab is open, and **Sections**, **Tables**, **Comments** and **History** follow the deepest tab you are viewing.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  ...
  // ── Workspace: left-rail tabs in HTML script guides
  {
    ...
    body: "The **BHN Scientific Directors Video** guide (*Molly Interview Conversation Guide*) now has tabs, listed to the left of the page, and each tab opens with its own heading:\n\n- **Overview** \u2014 project overview, voice and tone, filming plan, and the draft full intercut script.\n- **Molly** \u2014 her framing, the four interview prompts, follow-ups, *Keep in mind*, and the optional 2026 Symposium pickup line.\n- **Gilbert** \u2014 his Industry & Translation script.\n- **Darius** \u2014 his Innovation & Future Science script.\n- **Pillar leads** \u2014 the three pillar video scripts: ENGAGE (*Bridging the Gap*, Epshita Islam), EXPERIENCE (*The Industrial Immersion*, Yeseul Lee) and EQUIP (scene by scene).\n\nNothing was removed \u2014 the existing content was moved into the tabs as is. Everything stays editable, and share links get the same tabs.\n\n**The sidebar follows the tab you're viewing:**\n- **Sections** and **Tables** list only that tab's sections and tables, and **Add** adds to it.\n- **Comments** shows only the comments on that tab's text.\n- **History** shows only the saves that changed that tab, and **Restore** puts back just that tab, leaving the others as they are. Versions from before the split are under **Molly**; restoring one of those replaces the whole document. The previous layout is one click away in **History**.",
    kind: "improvement",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  ...
  // ── VentureConnect caps and reconciliation
  {
    ...
    body: "**The three-application limit is now real.** It was written on the application form and enforced nowhere \u2014 only the $5,000 cap existed, so an applicant could be approved a fourth and a fifth time for small amounts and nothing objected. Both limits are checked together now, and the slot check reports first: telling somebody with three awards that \u201c$3,500 remains\u201d is a near-miss that is simply false, and a reviewer would reasonably try to approve $3,000 and not understand the refusal. **A new figure: what was actually claimed.** Once receipts are in, enter the real amount against an approved or funded application. Two gaps are then shown and kept apart, because they mean different things and call for different responses: **\u0394 review** is what the committee trimmed off the request, **\u0394 spend** is what came back unspent against what was granted. A blank spend column means *not reconciled*, never *spent to the dollar* \u2014 entering the approved figure to tidy a row up would tell the variance report a grant was fully used when nobody has checked. **The whole position on one panel:** both limits with headroom, and every award the applicant holds \u2014 requested, approved, actual, and both deltas, with a total. **Three bugs fixed on the way.** (1) The cap query existed in a fourth hand-written copy on the review page, and that copy matched on the account only \u2014 so for an application with no account it matched every OTHER account-less application, charging the whole programme's public spend to one stranger. (2) In the shared version, a guard meant to match nothing for an applicant with neither account nor address was being overwritten by a later key in the same object, producing exactly the same result the guard existed to prevent. (3) Approving without typing an amount falls back to the requested figure \u2014 but the cap was checked against the amount that was *sent*, so an approval left blank passed the check at zero and then wrote the full request. An applicant with $500 of headroom could be approved for $2,000 by a reviewer who simply did not touch the field. **Two things this deliberately does not decide,** both now stated on the panel rather than buried: the limits are worded to applicants as *per company* but enforced *per person*, so two founders of the same company hold $5,000 and three slots each; and there is no date window, so the cap is for life rather than per fiscal year. Both need a decision, not a guess.",
    kind: "feature",
    visibleTo: STAFF,
    daysAgo: 0,
  },
  // ── Symposium AV comparison
  {
    ...
    body: "**Three Livecast documents side by side** \u2014 the 2025 quote, the 2025 final invoice, and the 2026 quote \u2014 line by line. **The three documents sit in a panel docked beside the table.** Hover a row and it follows; click to pin it and work with it. Each pane is the actual printed row, cropped out of the PDF at the coordinates where that item sits \u2014 not a re-typing. **Zoom** for small print, and switch to **full page** to see the whole sheet with that row outlined, for when the row alone is not enough context. Below 1280px the same panel opens as a sheet, so narrow screens get the feature rather than nothing. **That turned out to matter more than a nicety.** The 2026 quote lists five items at one price and strikes it through, charging less \u2014 and a strikethrough is a drawn rule, invisible to text extraction, which reports both numbers with no clue which one counts. The first version of this page read the projectors as $650 dearer. They are flat: listed at $1,950 for the pair, struck through, charged at $1,300 \u2014 the same $650 a unit as the 2025 NEC, for a better projector. Four more lines were wrong the same way: the Astera uplights are **half** last year's price, the Aputure lights and the riser decks are **free**, and the Sony cameras cost $450 rather than $900. Those five reductions come to exactly the $2,320 the quote prints as its \u201cDiscount\u201d, which is how we know they were read correctly. **So there are three true answers to how much it has gone up:** the printed line items say **+41.6%**, what Livecast will actually charge is **+14.1%**, and what BHN pays is **+31.2%**. The gap between the last two is the one to take into the conversation \u2014 the kit is 14% dearer, and the rest is $990 of one-off reductions 2025 got on top of its 10% (a \u201c50% off\u201d and a 100% item discount) that this quote does not repeat. **A separate section covers what changed that is not a price:** setting up the day before is not costed, the venue is still listed as \u201cNone\u201d, overtime is now $170/hour per technician past 10 hours with show labour booked at exactly 10, the cancellation window has widened from 48 hours to three weeks, and the deposit terms contradict the payment policy on the same page. Every figure reconciles against each document's own stated subtotal, discount and total by a test. The document crops are served behind the admin check rather than from public/ \u2014 they are pictures of a vendor's pricing.",
    kind: "feature",
    visibleTo: STAFF,
    daysAgo: 0,
  },
  // ── Public merch board
  {
    ...
    body: "**`/merch` shows the board to anyone**, with nothing removed: the filters, the tier grouping, Business Edge's break pricing, setup and decoration charges, the estimated spend, the supplier item codes, the write-ups and the watch-outs. It is the same page as Workspace \u2192 Marketing \u2192 Merch, without the sign-in. Send it to a partner, a colleague or the supplier. The link sits at the top of the internal board so it is obvious the page is public. **What follows from that:** the catalogue file behind it, `src/lib/merch/items.json`, is now published the moment it is committed \u2014 unit costs, the reasoning about who each item is for, and anything written in a watch-out. Anything that should not be read outside BHN does not belong in that file. The page is kept out of search engines, so it reaches people you send it to rather than people who stumble on it. **Fixed while here:** the supplier is serving a corrupt photo for the B-Safe key tool (nine stray bytes before the JPEG's start marker, which every browser refuses). The board already degraded to the product name; that fallback is one shared component now rather than two copies, so it holds on both pages.",
    kind: "feature",
    visibleTo: STAFF,
    daysAgo: 0,
  },
  ...
  // ── Newsletter → Code: review a paste, line by line
  {
    ...
    body: "**Newsletter → Review**, below the issue. Paste the HTML Mailchimp gives you, press **Render it for review**, and it appears exactly as it did before — except now anyone on the team can press **Leave a note**, click any part of it, and pin a comment there. Resolve them, reopen them, and **Show me where** scrolls back to the element and flashes it. Same experience as reviewing the issue this app generated, but on the thing that is actually going to send. It replaces a preview that could only be looked at. That one was read-only for a real reason — a paste rendered where this page can reach it could have run a campaign export's JavaScript with your session — but the fix turned out to be a narrower one: the frame keeps its origin, so notes can pin to elements, and script execution is switched off entirely. Nothing in the paste runs: not a `<script>`, not an `onerror`, not a `javascript:` link. **The notes are kept apart from the issue's own**, on purpose: the newsletter's editorial comments are counted into the \"N notes are still open\" line above the Approve button, and a remark about a Mailchimp paste should never make somebody hesitate to send.",
    kind: "feature",
    visibleTo: STAFF,
    daysAgo: 0,
  },
  ...
  {
    title: "2026 Training Week schedule corrected, and now written down in one place",
    body: "The week was described in four separate places \u2014 the seed script, the registration form, the flow chart, and the database \u2014 and the copies had drifted from the coordinators\u2019 planning grid.\n\n**One source of truth.** `lib/training-week/schedule-2026.ts` now holds the week: days, themes, leads, sessions, times, rooms and their booking status, facilitators, partner orgs, capacities, and the courses that run alongside it. The Admin calendar, the Workshop rows, the registration form\u2019s session list and the flow chart all derive from it, so a change to a time can no longer be applied to three of the four.\n\n**What actually changed in the schedule.**\n  \u2022 The two Monday company tours run **back to back**, not concurrently \u2014 CCRM 11:00\u201313:30, then Catalent 14:00\u201316:30. You can attend both, and the form no longer warns that you cannot.\n  \u2022 **CL3 runs the full day**, 09:30\u201317:00 (was 09:00\u201312:00), so it genuinely overlaps both tours \u2014 two clashes the form never used to mention.\n  \u2022 **Negotiation Skills** now ends at 16:30, half an hour after Communication Chameleon.\n  \u2022 The **BioHubNet innovation showcase** is 10:00\u201314:00 on the Wednesday (was 09:00\u201316:00), and carries its full name.\n  \u2022 Rooms and people are recorded: Room 850 (held 9\u20135) for Communication Chameleon with Claudia Ferryman of Rainmaker; big pod + 210/310 for Negotiation Skills with Glen Whyte; MaRS Jewel Box or POD220 for the showcase.\n\n**Times are read, not assumed.** Wall-clock times convert through the real `America/Toronto` offset rather than a hard-coded UTC-4, so a session moved past the start of November no longer lands an hour out.\n\nThe Admin calendar also now shows what the plan shows around the sessions: each day\u2019s programme, the Tuesday pizza lunch, and the two ENGAGE learning paths that run alongside the week. Calendar times are pinned to Toronto rather than read in the viewer\u2019s timezone.\n\nApplied to the live data by `scripts/apply-schedule-2026.ts`, which is a dry run until `--force`, writes one transaction, backs up every row it touches, and refuses to edit a document whose session list it cannot fully account for.",
    kind: "fix",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  ...
  {
    title: "Industry Insights: a speaker-intake link for the invited hiring professionals",
    body: "**`/events/2026-industry-insights/speaker`** \u2014 hand it to the twelve invited hiring professionals and they fill in their own **headshot** (with a drag-to-frame crop), a **250-character bio** with an AI shortener, their **LinkedIn**, and **what their session will cover**. No account needed.\n\nSubmissions land under **Workspace \u2192 Industry Insights \u2192 Speakers**, where you check them before anything goes on the website.\n\nIndustry Insights had no event row at all, so there was nowhere for a speaker to send anything. It is created as a **draft**: the speaker link works from a draft, and the event stays off the public `/events` listing beside the biohubnet.ca page that is already advertising it \u2014 two public pages for one event is a way to have one of them go stale.\n\nIts own subgroup rather than a fifth item under 2026 Symposium: it is a different event on a different day, and filing it there would be the same mistake as speakers living under Events, one level down.\n\nA **student registration form** was built for this event first, by misreading the request. It is not deleted \u2014 the biohubnet.ca page says registration details are still to be confirmed, so it will be wanted \u2014 but it is switched off, and `/apply/industry-insights-2026` says registration is closed rather than quietly taking answers nobody is watching for.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  ...
  {
    title: "EQUIP applicant emails: nothing sends without a reviewer choosing to send it",
    body: "Every EQUIP status change \u2014 claiming for review, approving, rejecting, funding, requesting more info, reversing an approval \u2014 used to email the applicant automatically. It no longer does. The **only** email that still fires on its own is the submission-received confirmation, the moment an applicant does the thing they're waiting to hear back on.\n\nEvery other applicant email is now a deliberate action from **Send email to applicant** on the review page (`/admin/equip/[id]`): pick a template (it defaults to whatever the current status suggests), **Preview** renders it with that applicant's real name, amount, and reviewer note, then **Send now** is its own click. The application remembers the last one actually sent.\n\n**Add / remove your own templates.** `/admin/equip/email-templates` now has a **Custom templates** section \u2014 not tied to any status. Name one, pick which stream(s) it applies to, write it (or describe the change and let **AI rewrite** draft it, the same assist the built-in templates already had), and it shows up in every application's send picker immediately. Delete any time; it only affects future sends.\n\n**Fixed: applicants named \u201cDr.\u201d were greeted \u201cHi Dr.,\u201d.** The greeting took the first word of the stored name, which for anyone recorded as \u201cDr. Jane Smith\u201d or \u201cProf Alex Osei\u201d was the honorific, not their name. It now skips Dr / Prof / Mr / Mrs / Ms / Miss / Mx before picking a first name.\n\n**Fixed: the in-platform submission confirmation was missing the PDF copy and internal BCC the public VentureConnect link already sent.** Applying through `/apply/venture-connect/[token]` (no login) always attached a PDF of the full application and quietly copied BioHubNet's own inbox; applying while signed in did neither. Signed-in VentureConnect submissions now get the same PDF attachment and internal copy.\n\n**Who gets that internal copy is admin-editable now**, from the same `/admin/equip/email-templates` page \u2014 **Internal copy recipients**, one address list per stream (VentureConnect, Innovation Fellowship; VentureLift has no PDF packet yet so there's nothing to copy). Used to be hardcoded in source.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
  {
    title: "Reviewers can mark up an application's attachments, without touching the file",
    body: "Open any application straight from the **queue** \u2014 Review now opens it over the list instead of navigating away, so working down the queue no longer loses your place and your filter on every back-press. The full page is one click away inside it, and everything it already did is unchanged.\n\n**Attachments are now readable in place.** Every PDF and image on an application renders page by page, instead of being a download link you had to open in another tab.\n\n**And you can pin a comment to a spot on the page.** Click anywhere on a page and leave a note; it pins there, numbered, and stays put at any zoom or window size. Notes live in a rail beside the document, jump you to their page when clicked, and can be resolved or reopened.\n\nTwo things worth being precise about:\n  \u2022 **The original file is never modified.** The upload in storage is byte-identical before and after \u2014 a note stores coordinates that point at it, nothing more. Deleting every note leaves the attachment exactly as the applicant sent it.\n  \u2022 **Reviewers only.** These are a separate table from the applicant comment thread, so there is no visibility setting to get wrong \u2014 nothing applicant-facing queries them at all. Notes are shared and unowned: any reviewer can read, add to, resolve or tidy any note, because it is one marked-up document a committee is reading together, not a pile of private annotations.\n\n**The AI triage summary now reads the attachments too**, not just the form fields \u2014 so the pitch deck, the support letters and the IP evidence count toward the summary. An attachment it cannot read (a scan with no text layer) is named as unread rather than quietly skipped, so the summary never implies it considered something it did not.\n\n**Fixed, and it was blocking exactly the people this is for:** attachments 404'd for EQUIP Review committee members and grant reviewers. The review page let them in; the file route only ever accepted an admin role. They can open every attachment now \u2014 and only that: uploading and deleting stay with the applicant and admins.",
    kind: "feature",
    visibleTo: ADMINS,
    daysAgo: 0,
  },
