...
export const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: "**Video Production \u2192 Production cost** adds up the 6 October shoot: camera (2D House, without their lens), the William White lens, sound and lighting (CamArt), parking for two, an insurance estimate for the three rental days, and lunch at U of T\u2019s meal allowance. Each section is marked **Quoted** or **Estimate**, and the total is at the top.",
  ...
  },
  {
    ...
    body: "In the **BHN Scientific Directors Video** guide, **Pillar leads** now opens into **ENGAGE**, **EXPERIENCE** and **EQUIP**, each holding that pillar\u2019s script. The new **Year in Review** tab holds the film for the Symposium on 29 October \u2014 concepts, a beat sheet, and a section for each pillar. Sub-tabs appear indented under whichever tab is open.",
  ...
  },
  {
    ...
    body: "The **BHN Scientific Directors Video** guide is split into tabs listed **to the left of the page**: **Overview**, **Molly**, **Gilbert**, **Darius** and **Pillar leads** (the ENGAGE, EXPERIENCE and EQUIP scripts). Each tab has its own heading. The sidebar follows the tab you're on: **Sections**, **Tables** and **Comments** show only that tab, and **History** lists the saves that changed it \u2014 **Restore** puts back just that tab.",
    path: "/admin/workspace/marketing/video",
    placement: "center",
    roles: ["admin", "superadmin"],
    cta: { label: "Open video projects", href: "/admin/workspace/marketing/video" },
